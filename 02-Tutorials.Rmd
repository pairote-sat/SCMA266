...
2.  A company's cash position, measured in
...
3.  Suppose that data on a stock price at
...
4.  What is the standard error (per annum) of the estimate obtained in Question 3?
...
5.  With the drift rate and the variance rate as given in the Question 2, What is the
